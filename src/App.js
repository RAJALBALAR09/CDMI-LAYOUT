...
import img2 from './image/asset 10.webp';
import img3 from './image/1.webp';
import img4 from './image/2.webp';
import img5 from './image/3.webp';
import img6 from './image/4.webp';
import img7 from './image/5.jpg';
import img8 from './image/6.webp';
...
import img21 from './image/7.png';
import img22 from './image/8.png';
import img23 from './image/9.png';
import img24 from './image/10.png';
import img25 from './image/11.png';
      ...
      <div className='container pd-y'>
        ...
        <div className='d-flex'>
          <div className='w-50 happy'>
            ...
            <p className='detail'>"I have joined creative multimedia institute for UI/UX Design course two months ago. Had a really great experience in learning the course. I am thankful to the sir who taught us really well with different approaches. This learning process gave me confidence on how to explore myself better with higher level of understanding. Thank you creative multimedia."</p>

            <div className='happy-bottom d-flex'>
              <img src={img12}></img>
              <div className='bottom-con'>
                <h3>KOLADIYA MANSI</h3>
                <h5><i>UI/UX Designer </i> <span>@ Patoliya Infotech</span></h5>
              </div>
            </div>
          </div>
